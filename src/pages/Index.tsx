    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative py-16 sm:py-24 px-4 bg-muted/30">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-6 max-w-2xl mx-auto">
            Il <strong className="text-foreground">Tredozio Trail</strong> è una gara di trail running 
            che si snoda tra i sentieri e le colline dell'Appennino romagnolo, 
            nel cuore della natura incontaminata di Tredozio.
            Organizzato da <a href="https://ginepro.cc" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2 hover:text-primary/80 transition-colors font-medium">GINEPRO</a>.
          </p>
      ...
      <footer className="py-8 px-4 border-t border-border/50 text-center">
        <p className="text-sm text-muted-foreground">
          © 2025 <a href="https://ginepro.cc" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">GINEPRO</a> — Tredozio Trail
        </p>
      </footer>
    </div>
  );
